  ...
  return (
    <div className="container-wide py-12">
      <header className="max-w-3xl">
        <p className="text-xs uppercase tracking-[0.3em] text-gold">B2B</p>
        <h1 className="heading-serif text-5xl md:text-6xl text-cream mt-2">
          Wholesale & <span className="italic text-gold">Trade</span>
        </h1>
      ...
      <section className="grid lg:grid-cols-2 gap-10 mt-14">
        <div>
          <h2 className="heading-serif text-3xl text-cream">What we offer</h2>
          <div className="gold-divider" />
          <ul className="mt-4 space-y-3">
            {BENEFITS.map((b) => (
              <li key={b} className="flex items-start gap-3 text-cream/85">
        ...
        <div className="card-surface p-8">
          <h2 className="font-serif text-2xl text-cream">Request our trade list</h2>
          ...
          <div className="mt-6 space-y-3">
            ...
            <Link href="/contact" className="block text-center text-sm text-gold hover:underline pt-2">
      ...
      <section className="mt-20 card-surface p-8 md:p-12 text-center">
        <p className="font-serif italic text-gold text-xl">"Wine Enthusiasts"</p>
        <p className="font-serif text-3xl md:text-4xl text-cream mt-2 max-w-3xl mx-auto">
