    ...
    <div className="container-wide py-12">
      <header className="max-w-3xl">
        ...
        <h1 className="heading-serif text-5xl md:text-6xl mt-2">
          Wholesale & <span className="italic text-gold-dark">Trade</span>
        </h1>
        <div className="gold-divider" />
        <p className="text-burgundy-700/85 text-lg leading-relaxed mt-4">
      ...
      <section className="grid lg:grid-cols-2 gap-10 mt-14">
        <div>
          <h2 className="heading-serif text-3xl text-burgundy-700">What we offer</h2>
          <div className="gold-divider" />
          <ul className="mt-4 space-y-3">
            {BENEFITS.map((b) => (
              <li key={b} className="flex items-start gap-3 text-burgundy-700/85">
        ...
        <div className="card-surface p-8">
          <h2 className="font-serif text-2xl text-burgundy-700">Request our trade list</h2>
      ...
      <section className="mt-20 card-surface p-8 md:p-12 text-center wash-cream">
        <p className="font-serif italic text-gold-dark text-xl">"Wine Enthusiasts"</p>
        <p className="font-serif text-3xl md:text-4xl text-burgundy-700 mt-2 max-w-3xl mx-auto">
